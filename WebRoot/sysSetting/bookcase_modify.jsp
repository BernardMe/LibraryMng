...
<script language="javascript">
   ...
   function updateshelf(){
       if(($("#shelfSpan").html()).indexOf("tip")>0){
    	   ...
    	   if(flag){
               $.post("shelf.action",{"m":"updateShelf","shelfname":($("#shelfname").val()+"架"),"shelfid":${param.shelfid}},function(data){
                   if(data=="success"){
                       window.location="shelf.action?m=queryAllShelf&page=${pu.page}";
                   }else{
                       alert("修改失败，请重新修改");
                       window.location="sysSetting/bookcase_modify.jsp?shelfid=${param.shelfid}&shelfname=${param.shelfname}";
                   }
               })
    	   }else{
    		   window.location="shelf.action?m=queryAllShelf&page=${pu.page}";
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center">
    <td width="35%" align="left" style="padding:5px;">书架原名称：</td>
    <td width="65%" align="left">
      <input  type="text"  value="${param.shelfname }" disabled="disabled" size="30" >  
      
        </td>
    </tr>
    <td width="35%" align="left" style="padding:5px;">书架新名称：</td>
    <td width="65%" align="left">
      <input name="shelfname" type="text" id="shelfname" value=""  size="30" onblur="checkshelf()">  
    ...
    <tr>
      ...
      <td><input id="btn" type="button" name="Submit" value="保存" class="button" onclick="updateshelf();" />
        &nbsp;
