...
var sysmenu='\
<table width=80>\
<tr><td id=library onMouseOver=overbg(library) onMouseOut=outbg(library)><a href="library_modify.html">图书馆信息</a></td></tr>\
...
var readermenu='\
<table width=90>\
<tr><td id=readerType onMouseOver=overbg(readerType) onMouseOut=outbg(readerType)><a href="readerType.html">读者类型管理</a></td></tr>\
<tr><td id=reader onMouseOver=overbg(reader) onMouseOut=outbg(reader)><a href="reader.html">读者档案管理</a></td></tr>\
</table>'
var bookmenu='\
<table width=90>\
<tr><td id=bookType onMouseOver=overbg(bookType) onMouseOut=outbg(bookType)><a href="bookType.html">图书类型设置</a></td></tr>\
...
var querymenu='\
<table width=90>\
<tr><td id=bookQuery onMouseOver=overbg(bookQuery) onMouseOut=outbg(bookQuery)><a href="bookQuery.html">图书档案查询</a></td></tr>\
